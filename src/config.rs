...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("camprodest.com".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Camprodest".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["camprodest.com"];
pub const RS_PUB_KEY: &str = "ORnhiBT41kHmj42GxZl5WjJ3v+VJNh1l4d7byY5ugFU=";
